...
![Introducing built-in media elements](graphics/7102EN_01_01.jpg)
...
![Introducing built-in media elements](graphics/7102EN_01_02.jpg)
...
![Easy validation](graphics/7102EN_01_03.jpg)
...
在开发 Windows8 应用程序时，我们可以使用 WindowsLibraryforJavaScript（`WinJS`）来实现更高级的数据到 HTML 元素的绑定。Win8 JavaScript 库利用 HTML`data-*`属性提供了一种以编程方式实现数据绑定的简单方法。
