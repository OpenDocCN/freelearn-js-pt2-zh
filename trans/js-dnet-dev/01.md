...
新的Visual Studio 2015 IDE 为开发 web 应用提供了许多丰富的功能，并且可以使用各种模板在不同的框架和应用模型上创建项目。早期版本已经支持 IntelliSense、彩色化和格式，但新的 Visual Studio 2015 IDE 还有一些改进，如下所示：
